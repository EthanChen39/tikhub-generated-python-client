...
T = TypeVar("T", bound="ChallengeSearchV2Request")


@_attrs_define
class ChallengeSearchV2Request:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_search_v2_request = cls(
            keyword=keyword,
            cursor=cursor,
            sort_type=sort_type,
        ...
        challenge_search_v2_request.additional_properties = d
        return challenge_search_v2_request
