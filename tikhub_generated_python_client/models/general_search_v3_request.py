...
T = TypeVar("T", bound="GeneralSearchV3Request")


@_attrs_define
class GeneralSearchV3Request:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        general_search_v3_request.additional_properties = d
        return general_search_v3_request
