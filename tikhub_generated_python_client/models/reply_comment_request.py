...
T = TypeVar("T", bound="ReplyCommentRequest")
...
class ReplyCommentRequest:
    ...
    Attributes:
        ...
        reply_id (Union[Unset, str]): Comment ID, which can be obtained from the comment data of the specified video.
    ...
    reply_id: Union[Unset, str] = "7420673787547419435"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reply_comment_request.additional_properties = d
        return reply_comment_request
