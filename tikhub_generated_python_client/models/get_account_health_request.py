...
T = TypeVar("T", bound="GetAccountHealthRequest")


@_attrs_define
class GetAccountHealthRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_account_health_request = cls(
            cookie=cookie,
            proxy=proxy,
        )

        get_account_health_request.additional_properties = d
        return get_account_health_request
