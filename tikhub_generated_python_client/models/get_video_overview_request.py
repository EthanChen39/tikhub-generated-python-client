...
T = TypeVar("T", bound="GetVideoOverviewRequest")


@_attrs_define
class GetVideoOverviewRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_video_overview_request = cls(
            cookie=cookie,
            proxy=proxy,
        )

        get_video_overview_request.additional_properties = d
        return get_video_overview_request
