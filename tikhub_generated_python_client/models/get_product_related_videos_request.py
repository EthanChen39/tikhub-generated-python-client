...
T = TypeVar("T", bound="GetProductRelatedVideosRequest")


@_attrs_define
class GetProductRelatedVideosRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_product_related_videos_request = cls(
            item_id=item_id,
            product_id=product_id,
            cookie=cookie,
            proxy=proxy,
        ...
        get_product_related_videos_request.additional_properties = d
        return get_product_related_videos_request
