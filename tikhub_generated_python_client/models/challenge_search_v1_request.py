...
T = TypeVar("T", bound="ChallengeSearchV1Request")


@_attrs_define
class ChallengeSearchV1Request:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_search_v1_request = cls(
            keyword=keyword,
            cursor=cursor,
            sort_type=sort_type,
        ...
        challenge_search_v1_request.additional_properties = d
        return challenge_search_v1_request
