...
T = TypeVar("T", bound="GetVideoDetailedStatsRequest")


@_attrs_define
class GetVideoDetailedStatsRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_video_detailed_stats_request = cls(
            item_id=item_id,
            cookie=cookie,
            proxy=proxy,
        ...
        get_video_detailed_stats_request.additional_properties = d
        return get_video_detailed_stats_request
