...
T = TypeVar("T", bound="GetProductListRequest")
...
class GetProductListRequest:
    ...
    Attributes:
        ...
        start_date (Union[Unset, str]): 开始日期，如 '2025-04-01'/ Start Date, e.g. '2025-04-01' Default: '2025-04-01'.
        end_date (Union[Unset, str]): 结束日期，如 '2025-05-01'/ End Date, e.g. '2025-05-01' Default: '2025-05-01'.
        page (Union[Unset, int]): 页码/Page Number Default: 0.
    """

    cookie: Union[Unset, str] = "Your_Cookie_String"
    proxy: Union[None, Unset, str] = ""
    start_date: Union[Unset, str] = "2025-04-01"
    end_date: Union[Unset, str] = "2025-05-01"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_product_list_request.additional_properties = d
        return get_product_list_request
