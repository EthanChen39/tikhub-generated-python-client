...
T = TypeVar("T", bound="GeneralSearchV1Request")


@_attrs_define
class GeneralSearchV1Request:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        general_search_v1_request.additional_properties = d
        return general_search_v1_request
