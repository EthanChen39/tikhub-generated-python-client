...
T = TypeVar("T", bound="GetAccountOverviewRequest")


@_attrs_define
class GetAccountOverviewRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_account_overview_request = cls(
            cookie=cookie,
            proxy=proxy,
            start_date=start_date,
        )

        get_account_overview_request.additional_properties = d
        return get_account_overview_request
