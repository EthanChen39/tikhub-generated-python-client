...
T = TypeVar("T", bound="VideoSearchV1Request")


@_attrs_define
class VideoSearchV1Request:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        video_search_v1_request.additional_properties = d
        return video_search_v1_request
