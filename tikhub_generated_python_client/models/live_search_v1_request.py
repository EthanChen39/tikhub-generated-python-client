...
T = TypeVar("T", bound="LiveSearchV1Request")


@_attrs_define
class LiveSearchV1Request:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        live_search_v1_request.additional_properties = d
        return live_search_v1_request
