...
T = TypeVar("T", bound="ExperienceSearchRequest")
...
class ExperienceSearchRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        experience_search_request.additional_properties = d
        return experience_search_request
