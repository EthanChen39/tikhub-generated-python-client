...
T = TypeVar("T", bound="DiscussSearchRequest")


@_attrs_define
class DiscussSearchRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        discuss_search_request.additional_properties = d
        return discuss_search_request
