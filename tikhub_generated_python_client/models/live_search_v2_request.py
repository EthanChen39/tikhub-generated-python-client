...
T = TypeVar("T", bound="LiveSearchV2Request")


@_attrs_define
class LiveSearchV2Request:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        live_search_v2_request.additional_properties = d
        return live_search_v2_request
