...
T = TypeVar("T", bound="GeneralSearchV2Request")


@_attrs_define
class GeneralSearchV2Request:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        general_search_v2_request.additional_properties = d
        return general_search_v2_request
