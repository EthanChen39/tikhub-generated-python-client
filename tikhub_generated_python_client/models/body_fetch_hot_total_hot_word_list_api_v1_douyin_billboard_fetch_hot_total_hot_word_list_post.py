...
T = TypeVar("T", bound="BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost")
...
class BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_fetch_hot_total_hot_word_list_api_v1_douyin_billboard_fetch_hot_total_hot_word_list_post = cls(
            page_num=page_num,
            page_size=page_size,
        ...
        body_fetch_hot_total_hot_word_list_api_v1_douyin_billboard_fetch_hot_total_hot_word_list_post.additional_properties = d
        return body_fetch_hot_total_hot_word_list_api_v1_douyin_billboard_fetch_hot_total_hot_word_list_post
