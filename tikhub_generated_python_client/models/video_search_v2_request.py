...
T = TypeVar("T", bound="VideoSearchV2Request")


@_attrs_define
class VideoSearchV2Request:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        video_search_v2_request.additional_properties = d
        return video_search_v2_request
