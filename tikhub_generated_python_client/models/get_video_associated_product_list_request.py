...
T = TypeVar("T", bound="GetVideoAssociatedProductListRequest")


@_attrs_define
class GetVideoAssociatedProductListRequest:
    """
    Attributes:
        item_ids (list[str]): 视频 ID 列表/Video ID List
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_video_associated_product_list_request = cls(
            item_ids=item_ids,
            cookie=cookie,
            proxy=proxy,
        ...
        get_video_associated_product_list_request.additional_properties = d
        return get_video_associated_product_list_request
