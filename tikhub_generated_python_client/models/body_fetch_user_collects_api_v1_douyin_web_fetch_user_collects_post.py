...
T = TypeVar("T", bound="BodyFetchUserCollectsApiV1DouyinWebFetchUserCollectsPost")


@_attrs_define
class BodyFetchUserCollectsApiV1DouyinWebFetchUserCollectsPost:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_fetch_user_collects_api_v1_douyin_web_fetch_user_collects_post = cls(
            cookie=cookie,
            max_cursor=max_cursor,
            counts=counts,
        )

        body_fetch_user_collects_api_v1_douyin_web_fetch_user_collects_post.additional_properties = d
        return body_fetch_user_collects_api_v1_douyin_web_fetch_user_collects_post
