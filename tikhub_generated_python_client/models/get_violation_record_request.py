...
T = TypeVar("T", bound="GetViolationRecordRequest")


@_attrs_define
class GetViolationRecordRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_violation_record_request = cls(
            cookie=cookie,
            proxy=proxy,
            page=page,
        )

        get_violation_record_request.additional_properties = d
        return get_violation_record_request
