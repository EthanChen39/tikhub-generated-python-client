...
def sync_detailed(
    *,
    ...
    r"""获取微信公众号文章详情的HTML/Get Wechat MP Article Detail HTML
    ...
    # [English]
    ### Purpose:
    - Get WeChat MP Article Detail, if you need detailed JSON format data, please use the
    `/api/v1/wechat_mp/web/fetch_mp_article_detail_json` interface
