...
def sync_detailed(
    *,
    ...
    r"""快手单一视频查询接口V1/Kuaishou single video query API V1
    ...
    # [English]
    ### Purpose:
    - Fetch single video data, if this API continuously fails, you can try to use the more expensive V2
    API for redundant requests.
    ### Parameters:
