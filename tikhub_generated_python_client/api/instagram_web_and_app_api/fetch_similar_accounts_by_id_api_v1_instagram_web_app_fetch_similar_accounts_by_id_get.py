...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/instagram/web_app/fetch_similar_accounts_by_id",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    r"""根据用户ID获取相似的账户数据/Get similar accounts by ID

     # [中文]
    ### 用途:
    - 根据Instagram用户ID获取相似的账户数据
    ...
    # [English]
    ### Purpose:
    - Get similar accounts by Instagram user ID
