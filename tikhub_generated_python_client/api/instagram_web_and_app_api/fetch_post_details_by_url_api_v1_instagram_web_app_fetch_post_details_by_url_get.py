...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/instagram/web_app/fetch_post_details_by_url",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    r"""根据帖子链接获取帖子详情数据/Get post detail by post URL

     # [中文]
    ### 用途:
    - 根据Instagram帖子URL获取帖子详情数据
    ...
    # [English]
    ### Purpose:
    - Get post detail by Instagram post URL
