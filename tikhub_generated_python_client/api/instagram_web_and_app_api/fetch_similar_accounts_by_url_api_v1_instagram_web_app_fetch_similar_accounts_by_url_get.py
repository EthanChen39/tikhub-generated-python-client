...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/instagram/web_app/fetch_similar_accounts_by_url",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    r"""根据用户链接获取相似的账户数据/Get similar accounts by URL

     # [中文]
    ### 用途:
    - 根据Instagram用户链接获取相似的账户数据
    ...
    # [English]
    ### Purpose:
    - Get similar accounts by Instagram user URL
