...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/instagram/web_app/fetch_user_posts_and_reels_by_user_id",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    r"""用户帖子与快拍-用户ID/Get user posts and reels by user ID
    ...
    # [English]
    ### Purpose:
    - Get user posts and reels by user ID
