...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/instagram/web_app/fetch_hashtag_posts_by_keyword_v3",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    r"""话题作品V3/Get hashtag posts by keyword V3
    ...
    # [English]
    ### Purpose:
    - Get hashtag posts by keyword V3
    ...
    Args:
        ...
        feed_type (str): Feed类型/Feed type: top, recent
