...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/instagram/web_app/fetch_location_info_by_location_id",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    r"""根据地点ID获取地点数据/Get location by location ID

     # [中文]
    ### 用途:
    - 根据Instagram地点ID获取地点数据
    ...
    # [English]
    ### Purpose:
    - Get location by Instagram location ID
