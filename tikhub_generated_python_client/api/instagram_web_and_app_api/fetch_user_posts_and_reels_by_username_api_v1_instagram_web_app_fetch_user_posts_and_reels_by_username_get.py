...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/instagram/web_app/fetch_user_posts_and_reels_by_username",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    r"""用户帖子与快拍-用户名/Get user posts and reels by username
    ...
    # [English]
    ### Purpose:
    - Get user posts and reels by username
