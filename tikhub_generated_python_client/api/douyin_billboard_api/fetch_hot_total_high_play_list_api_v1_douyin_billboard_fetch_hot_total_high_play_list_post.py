...
from ...models.body_fetch_hot_total_high_play_list_api_v1_douyin_billboard_fetch_hot_total_high_play_list_post import (
...
def sync_detailed(
    *,
    ...
    r"""获取高完播率榜/Fetch high completion rate list
