...
from ...models.body_fetch_hot_total_high_topic_list_api_v1_douyin_billboard_fetch_hot_total_high_topic_list_post import (
...
def sync_detailed(
    *,
    ...
    r"""获取热度飙升的话题榜/Fetch topic list with rising popularity
