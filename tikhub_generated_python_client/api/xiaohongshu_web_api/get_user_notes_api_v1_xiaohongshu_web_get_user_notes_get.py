...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/xiaohongshu/web/get_user_notes",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    r"""获取用户的笔记 V1/Get user notes V1
    ...
    - lastCursor: Last cursor, empty for the first request, use the last NoteID returned in the last
