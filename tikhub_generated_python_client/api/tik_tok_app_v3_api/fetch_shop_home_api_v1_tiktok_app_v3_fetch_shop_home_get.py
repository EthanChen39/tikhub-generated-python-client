...
def sync_detailed(
    *,
    ...
    r"""获取商家主页数据/Get shop home page data
    ...
    ### Parameters:
    - page_id: Page id of the crawled shop home page, which can be obtained from the interface
    ...
    Args:
        page_id (str): 爬取的商家主页Page id/Page id of the crawled shop home page
